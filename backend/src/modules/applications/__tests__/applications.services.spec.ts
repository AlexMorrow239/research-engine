...
describe("ApplicationsService", () => {
  ...
  describe("create", () => {
    it("should create a new application successfully", async () => {
      ...
      jest
        ...
        .mockResolvedValue("saved-resume.pdf");
      jest
    ...
    it("should throw BadRequestException if project is not published", async () => {
      ...
      await expect(
        service.create("project1", mockApplication, mockFile)
  ...
  describe("updateStatus", () => {
    ...
    it("should throw NotFoundException if application not found", async () => {
      ...
      await expect(
        service.updateStatus("prof1", "app1", ApplicationStatus.CLOSED)
  ...
  describe("getResume", () => {
    ...
    it("should throw NotFoundException if application not found", async () => {
      ...
      await expect(service.getResume("prof1", "app1")).rejects.toThrow(
        NotFoundException
      );
    });
