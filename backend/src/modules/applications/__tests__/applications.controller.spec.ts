...
describe("ApplicationsController", () => {
  ...
  describe("create", () => {
    ...
    it("should create application successfully", async () => {
      jest
        ...
        .mockResolvedValue(mockApplicationData as any);
    ...
    it("should handle invalid application data", async () => {
      ...
      await expect(
        controller.create("project1", invalidData as any, mockFile)
  ...
  describe("findAll", () => {
    it("should return all applications for a project", async () => {
      ...
      jest
        .spyOn(service, "findProjectApplications")
    ...
    it("should handle project not found", async () => {
      ...
      await expect(
        controller.findAll("invalid-project", mockProfessor as any)
