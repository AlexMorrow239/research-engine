  ...
  describe("create", () => {
    ...
    it("should throw ConflictException when email already exists", async () => {
      jest
        ...
        .mockResolvedValue({ email: createProfessorDto.email });

      await expect(service.create(createProfessorDto)).rejects.toThrow(
        ConflictException
      );
    });
  ...
  describe("updateProfile", () => {
    ...
    it("should update professor profile successfully", async () => {
      ...
      jest
        ...
        .mockResolvedValue(updatedProfessor);
