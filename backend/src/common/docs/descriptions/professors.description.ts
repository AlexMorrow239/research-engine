export const ProfessorDescriptions = {
  ...
  responses: {
    createSuccess:
      "Professor account successfully created with provided details",
    ...
    profileUpdated:
      "Professor profile successfully updated with provided changes",
    ...
    invalidPasswordFormat:
      "New password does not meet the required format criteria",
    ...
    invalidCredentials:
      "The provided professor credentials or admin password are invalid",
