...
export const updateProfessorExamples = {
  ...
  partialUpdate: {
    ...
    description:
      "Example of updating specific fields while leaving others unchanged",
    value: {
      title: "Associate Professor",
...
export const reactivateExamples = {
  ...
  wrongAdmin: {
    ...
    description:
      "Example of a reactivation request with incorrect admin password",
    value: {
      email: "professor.test@miami.edu",
      password: "SecurePass123!",
  ...
  wrongCredentials: {
    ...
    description:
      "Example of a reactivation request with incorrect professor credentials",
    value: {
